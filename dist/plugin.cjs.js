...
(function (ATTRIBUTION_NETWORK) {
  ATTRIBUTION_NETWORK[(ATTRIBUTION_NETWORK["APPLE_SEARCH_ADS"] = 0)] =
    "APPLE_SEARCH_ADS";
...
(function (BILLING_FEATURE) {
   ...
   */
  BILLING_FEATURE[(BILLING_FEATURE["SUBSCRIPTIONS_UPDATE"] = 1)] =
    "SUBSCRIPTIONS_UPDATE";
  /**
   * Purchase/query for in-app items on VR.
   */
  BILLING_FEATURE[(BILLING_FEATURE["IN_APP_ITEMS_ON_VR"] = 2)] =
    "IN_APP_ITEMS_ON_VR";
  /**
   * Purchase/query for subscriptions on VR.
   */
  BILLING_FEATURE[(BILLING_FEATURE["SUBSCRIPTIONS_ON_VR"] = 3)] =
    "SUBSCRIPTIONS_ON_VR";
  /**
   * Launch a price change confirmation flow.
   */
  BILLING_FEATURE[(BILLING_FEATURE["PRICE_CHANGE_CONFIRMATION"] = 4)] =
    "PRICE_CHANGE_CONFIRMATION";
})(exports.BILLING_FEATURE || (exports.BILLING_FEATURE = {}));
exports.PRORATION_MODE = void 0;
(function (PRORATION_MODE) {
  PRORATION_MODE[
    (PRORATION_MODE["UNKNOWN_SUBSCRIPTION_UPGRADE_DOWNGRADE_POLICY"] = 0)
  ] = "UNKNOWN_SUBSCRIPTION_UPGRADE_DOWNGRADE_POLICY";
  /**
   * Replacement takes effect immediately, and the remaining time will be
   * prorated and credited to the user. This is the current default behavior.
   */
  PRORATION_MODE[(PRORATION_MODE["IMMEDIATE_WITH_TIME_PRORATION"] = 1)] =
   ...
   */
  PRORATION_MODE[(PRORATION_MODE["IMMEDIATE_AND_CHARGE_PRORATED_PRICE"] = 2)] =
    "IMMEDIATE_AND_CHARGE_PRORATED_PRICE";
  /**
   * Replacement takes effect immediately, and the new price will be charged on
   * next recurrence time. The billing cycle stays the same.
   */
  PRORATION_MODE[(PRORATION_MODE["IMMEDIATE_WITHOUT_PRORATION"] = 3)] =
...
(function (INTRO_ELIGIBILITY_STATUS) {
  ...
  INTRO_ELIGIBILITY_STATUS[
    (INTRO_ELIGIBILITY_STATUS["INTRO_ELIGIBILITY_STATUS_UNKNOWN"] = 0)
  ] = "INTRO_ELIGIBILITY_STATUS_UNKNOWN";
  /**
   * The user is not eligible for a free trial or intro pricing for this product.
   */
  INTRO_ELIGIBILITY_STATUS[
    (INTRO_ELIGIBILITY_STATUS["INTRO_ELIGIBILITY_STATUS_INELIGIBLE"] = 1)
...
const NativePurchases = core.registerPlugin("NativePurchases", {
  web: () =>
    Promise.resolve()
      ...
      .then((m) => new m.NativePurchasesWeb()),
});
